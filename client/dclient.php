...
$page_open = 'Download DownCraft Client';
...
<head>
	...
	<title>Download DownCraft Client - <?= $Controller->Settings('name'); ?>
					...
					<div class="panel panel-primary">
						<div class=panel-heading>
							<h5 class=panel-title>
								...
								</i> Download DownCraft Client</h5>
							</div>
							<div class=panel-body>
								<center>
									<h5><?= $_SESSION['account']['username']; ?>, here you can download DownCraft Client for CFW & HEN Version 1.0</h5>
											<br>
								<button class="button" onclick="window.location.href = 'https://mega.nz/file/UEsnkSqZ#_OWebvK9HvQ0mFqVkr59OjOoMaP1UP6NDK7tyf2RTt0';">Download DownCraft Client V1</button>
								<br>
								</center>
							</div> 
						</div>
						<br>
						<center><img src="https://downcraft.xyz/client/client.PNG" alt="Demo" class="center"></center>
						<br>
						<center><b>DownCraft Client is a new version. Working like a RTM for CFW & HEN. It's just a new UI (Design) like a cheat Minecraft PC for that it's calling "Client".</b></center>
						<br>
					</div>
				</div>

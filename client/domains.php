    ...
    <body class=material-menu id=top>
        <?php require 'templates/header.tpl'; ?>
            <?php require 'templates/navigator.tpl'; ?>
                        ...
                        <div class=col-md-12>
                            <div class="panel panel-primary">
                                <div class=panel-heading>
                                    <h5 class=panel-title><i class="fa fa-globe"></i> Mes noms de domaine</h5></div>
                        ...
                        <div class=container-fluid>
                            <div class=row>
                                <div class="col-md-12 col-sm-12">
                                    <div class=footer-center align=center><span>© 2015 - <?= date('Y'); ?> <?= $Controller->Settings('name'); ?>&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;Tous droits réservés&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;Développé par <a href=https://twitter.com/MathisLts>Mathis L</a>&nbsp;&nbsp;&nbsp;&bull;&nbsp;&nbsp;&nbsp;Version 1.2</span></div>
                                </div>
                            </div>
                        </div>
                    </footer>
                </section><a id=scrollTop href=#top><i class=icon-arrow-up12></i></a>
                ...
                <?php if(isset($_SESSION['aucundomaine'])) { echo $_SESSION['aucundomaine']; unset($_SESSION['aucundomaine']); } ?>

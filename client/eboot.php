...
$page_open = 'Download EBOOT DownCraft';
...
<head>
	...
	<title>Download EBOOT DownCraft - <?= $Controller->Settings('name'); ?>
					...
					<div class="panel panel-primary">
						<div class=panel-heading>
							<h5 class=panel-title>
								...
								</i> Download EBOOT DownCraft</h5>
							</div>
							<div class=panel-body>
								<center>
									<h5><?= $_SESSION['account']['username']; ?>, here you can download the EBOOT Custom for Minecraft 1.84 CFW/HEN</h5>
										<b>/!\ If you are using the EBOOT on HEN, use the version BLES01976 /!\</b>
											<br>
											<br>
								<button class="button" onclick="window.location.href = 'https://mega.nz/file/jOAQ1YLL#qLv-_JiANKvEHFMBd6hQTl7bkxeM7-35rg2Y0TcWgic';">Download EBOOT V1</button>
								<br>
								</center>
							</div> 
						</div>
						<br>
						<center><img src="https://downcraft.xyz/client/eboot.PNG" alt="Demo" class="center"></center>
						<br>
						<center><b>DownCraft modded eboot, use this eboot if you can't use any PC. When you will start your Minecraft, all mods will be instant enabled, and you can't disable it</b></center>
												<center><b>PVP Mods are legit and you can play on Online with make a world or just join worlds of yours friends.</b></center>
						<br>
					</div>
				</div>

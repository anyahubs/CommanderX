...
$page_open = 'Download Custom Stuffs';
...
<head>
	...
	<title>Download Custom Stuffs - <?= $Controller->Settings('name'); ?>
					...
					<div class="panel panel-primary">
						<div class=panel-heading>
							<h5 class=panel-title>
								...
								</i> Minecraft Custom Stuffs</h5>
							</div>
							<div class=panel-body>
								<center>
									<h4>I have add this page for users, need custom skins or some stuffs</h4>
								    <h4><b>if you using this don't remove credits from the owner !</b></h4>
									<h4><b>Some stuffs are make by the community, if you want post your stuff on this page you need to contact me on discord</b></h4>
									<h4>MisakiAuSki❄#0057</h4>
									</center>
							</div> 
						</div>
															<center><h5><b>- Models Misaki V2 -</h5></center></b>
						<center><img src="http://downcraft.pw/client/img_stuffs/model_v2.png" alt="Demo" class="center" width="600" height="300"></center>
						<br>
						<center><b>Custom Models Skins Pack Misaki V2 (Made By MisakiAuSki)</b></center>
												<center><b>Some models, this skins pack is unfinished !</b></center>
							<center><button class="button" onclick="window.location.href = 'http://downcraft.pw/client/img_stuffs/model_misakiv2.pck';">Download Skins Pack Models Misaki V2</button></center>
							<br>
							<br>
					</div>
				</div>

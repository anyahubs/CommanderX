...
?>
<script>alert('Thanks for have purchase DownCraft RTM Premium, contact Misaki Dev on discord for he create you a account in tool Premium. For any questions join the server discord.');</script><!doctype html>
<html lang=en>
<head>
